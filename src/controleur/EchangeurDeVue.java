...
public class EchangeurDeVue {
    ...
    static {
        cache = new HashMap<>();
        vues.put("vcp", "..\\vue\\vueChoixPseudo.fxml");
        vues.put("ve", "..\\vue\\vueExporter.fxml");
        vues.put("vi", "..\\vue\\vueImporter.fxml");
        vues.put("vt", "..\\vue\\VueTemporaire.fxml");
        
        System.out.println("intitialisation ok");
